...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
    ...
    <div class="title">
      ...
      $data = $CI -> Advertisement_model -> getsmalladvertisment(1,1);
  ...
  <div class="blog_even clearfix">
    ...
    <div class="col-lg-6 col-sm-12">
     ...
     <div class="title">
      			...
      			$data = $CI -> Advertisement_model -> getsmalladvertisment(2,2);
...
<div class="col-md-4">
 ...
 <div class="container">
 	...
 	<?php 
      			...
      			$data = $CI -> Advertisement_model -> getsmalladvertisment(2,6);

      			if(!empty($data)){

      				foreach ($data as $key => $value) {?>

      						<a href="<?php echo $value->link;?>" target="_blank"><img src="<?php echo base_url() . $path . $value -> path; ?>" width="49%" height="90"></a>
