            ...
            <div class="span2 main-menu-span">
                ...
                <div class="well nav-collapse sidebar-nav">    
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <?php if (in_array('banner_view', $allowed)) {?><li><a title="Manage Banner" class="ajax-link" data-rel="tooltip" href="<?php echo base_url().'administrator/banner';?>"><i class="icon-home"></i><span class="hidden-tablet"> Manage Banner</span></a></li></li><?php }?>
                        <?php if (in_array('banner_add', $allowed)) {?><li><a title="Add Banner" class="ajax-link" data-rel="tooltip" href="<?php echo base_url().'administrator/banner/add';?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Banner</span></a></li></li><?php }?>                        
                    </ul>                    
                </div><!--/.well -->
                <?php }?> 
