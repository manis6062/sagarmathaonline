    ...
    <div class="row-fluid sortable">        
                <div class="box span12">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> Teams</h2>
                    </div>
                                        ...
                                        <tr class="item" data-tt-id='<?php echo $count;?>'>
                                            ...
                                            <td class="action">
                                                <?php if(in_array('theme_option_update', $allowed)){?>
                                                    <a href="<?php echo site_url(ADMIN_PATH . 'team/editPage/' . $values->id); ?>"><img src="<?php echo base_url(); ?>/style/img/edit.png" alt="edit"></a> 
                                                <?php }?>
                                                <?php if(in_array('theme_option_update', $allowed)){?> 
